...
# 156.25 MHz
create_clock -period 6.400 -name clk_mgtref -waveform {0.000 3.200} [get_ports refclk_p]
set_property PACKAGE_PIN M15 [get_ports refclk_p]
set_property PACKAGE_PIN M14 [get_ports refclk_n]
...
set_property PACKAGE_PIN P2 [get_ports {rxp[8]}]
set_property PACKAGE_PIN P1 [get_ports {rxn[8]}]
set_property PACKAGE_PIN P7 [get_ports {txp[8]}]
set_property PACKAGE_PIN P6 [get_ports {txn[8]}]
set_property PACKAGE_PIN N4 [get_ports {rxp[9]}]
set_property PACKAGE_PIN N3 [get_ports {rxn[9]}]
set_property PACKAGE_PIN N9 [get_ports {txp[9]}]
set_property PACKAGE_PIN N8 [get_ports {txn[9]}]
set_property PACKAGE_PIN M2 [get_ports {rxp[10]}]
set_property PACKAGE_PIN M1 [get_ports {rxn[10]}]
set_property PACKAGE_PIN M7 [get_ports {txp[10]}]
set_property PACKAGE_PIN M6 [get_ports {txn[10]}]
